      ...
      <div className="text-center mb-12">
        ...
        <div className="prose prose-lg mx-auto mt-5">
          <div className="bg-white rounded-lg shadow-sm border p-8 mb-8 border-gray-200">
            ...
            <p className="text-gray-600 mb-4">
              ...
              maintain. We believe that great web development should be
              accessible to everyone.
            </p>
            <p className="text-gray-600">
              Our team is passionate about clean code, modern design, and
              creating experiences that users love. We use the latest
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white rounded-lg shadow-sm border p-6 border-gray-200">
            ...
            <p className="text-gray-600">
              To make web development simple, accessible, and enjoyable for
              developers of all skill levels while creating amazing user
              experiences.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6 border-gray-200">
            ...
            <p className="text-gray-600">
              A world where anyone can create beautiful, functional websites
              without getting overwhelmed by complex tools and frameworks.
            </p>
          </div>
        </div>
      </div>
